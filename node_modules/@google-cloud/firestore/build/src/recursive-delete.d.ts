 ...
 */
export declare const MAX_PENDING_OPS = 5000;
/**
...
export declare class RecursiveDelete {
     ...
     */
    constructor(firestore: Firestore, writer: BulkWriter, ref: firestore.CollectionReference<unknown> | firestore.DocumentReference<unknown>);
    /**
