...
import 'package:lets_connect/repositories/user/user_repository.dart';
              ...
              state.isGridView
                ...
                delegate: SliverChildBuilderDelegate(
                    ...
                    return GestureDetector(
                      onTap: () =>
                      Navigator.of(context).pushNamed(CommentsScreen.routeName, arguments: CommentScreenArgs(post : post)),
